  ...
  return (
    <section className="space-y-7 pb-12">
      <nav aria-label="RFQ navigation" className="flex flex-wrap gap-2">
        ...
        <Link href="/pm/suppliers/rfq/sites" className="flex min-h-11 items-center rounded-xl border border-sky-300/20 bg-sky-400/10 px-4 text-sm font-medium text-sky-100">
          Site Cost RFQ — 446 จุด
        </Link>
